...
Route::middleware(['auth', 'permission'])->group(function () {
    ...
    Route::get('product-groups', [\App\Http\Controllers\ProductGroupController::class, 'index'])->name('product_groups.index');
    Route::post('product-groups', [\App\Http\Controllers\ProductGroupController::class, 'store'])->name('product_groups.store');
    Route::delete('product-groups/{id}', [\App\Http\Controllers\ProductGroupController::class, 'destroy'])->name('product_groups.destroy');
    ...
    Route::match(['get', 'post'], 'reports/export', [\App\Http\Controllers\ReportController::class, 'export'])->name('reports.export');
});
