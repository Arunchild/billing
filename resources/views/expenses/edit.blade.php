...
<div class="d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeIn">
    <div>
        <h2 class="mb-1 fw-bold text-primary">Edit Expense</h2>
        <p class="text-muted mb-0">Modify expense details</p>
    </div>
    <div>
                ...
                <form action="{{ route('expenses.update', $expense->id) }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $expense->name }}" required placeholder="e.g. Office Rent">
                        </div>
                        <div class="col-md-6">
