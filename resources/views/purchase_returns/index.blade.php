...
<div class="card mb-3 animate__animated animate__fadeIn">
    <div class="card-body p-2">
        <form action="{{ route('purchase_returns.index') }}" method="GET" id="filterForm" class="row g-2 align-items-center">
            <div class="col-md-4">
                <div class="input-group input-group-sm">
                    <input type="text" name="search" class="form-control" placeholder="Search Return # or Supplier..." value="{{ request('search') }}">
                    <button class="btn btn-primary" type="submit"><i class="fas fa-search"></i></button>
                </div>
            </div>

            <div class="col-md-2 text-end ms-auto">
                <a href="{{ route('purchase_returns.create') }}" class="btn btn-primary btn-sm w-100">
            ...
            <table class="table table-hover mb-0" style="font-size: 0.85rem;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fw-bold">{{ $return->supplier->name }}</td>
                        ...
                        <td class="text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                                    <li><a class="dropdown-item" href="{{ route('purchase_returns.edit', $return->id) }}"><i class="fas fa-edit text-primary me-2"></i> View / Modify</a></li>
                                    <li><a class="dropdown-item" href="{{ route('purchase_returns.print', $return->id) }}" target="_blank"><i class="fas fa-print text-secondary me-2"></i> Print</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li>
                                        <form action="{{ route('purchase_returns.destroy', $return->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                            @method('DELETE')
