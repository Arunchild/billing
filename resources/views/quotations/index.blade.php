...
<div class="card mb-3 animate__animated animate__fadeIn">
    <div class="card-body p-2">
        <form action="{{ route('quotations.index') }}" method="GET" id="filterForm" class="row g-2 align-items-center">
            <div class="col-md-2">
...
<div class="px-2 py-2 mb-2 d-flex align-items-center gap-3 animate__animated animate__fadeIn">
    <span class="fw-bold text-muted small text-uppercase">Quotation(s)</span>
        ...
        <div class="table-responsive" style="min-height: 400px; padding-bottom: 150px;">
            <table class="table table-hover mb-0" style="font-size: 0.85rem;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><input type="checkbox" name="selected_quotations[]" value="{{ $quotation->id }}"></td>
                        ...
                        <td class="text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                                    <li><a class="dropdown-item" href="{{ route('quotations.edit', $quotation->id) }}"><i class="fas fa-edit text-primary me-2"></i> View / Modify</a></li>
                                    <li><a class="dropdown-item" href="{{ route('quotations.print', $quotation->id) }}" target="_blank"><i class="fas fa-print text-secondary me-2"></i> Print / Export</a></li>
                                    <li><a class="dropdown-item" href="{{ route('quotations.clone', $quotation->id) }}"><i class="fas fa-copy text-info me-2"></i> Create Copy</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li>
                                        <form action="{{ route('quotations.destroy', $quotation->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                            @method('DELETE')
...
<script>
    ...
    function bulkPrint() {
        const selected = Array.from(document.querySelectorAll('input[name="selected_quotations[]"]:checked')).map(cb => cb.value);
