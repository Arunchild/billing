    ...
    function addRow() {
        ...
        const newRowHtml = `
            <tr class="item-row animate__animated animate__fadeIn">
                ...
                <td>
                    <input type="number" name="items[${rowCount}][price]" class="form-control price-input text-end" step="0.01" data-entered-price="" onchange="calculateRow(this)" onkeyup="calculateRow(this)">
                </td>
                <td>
