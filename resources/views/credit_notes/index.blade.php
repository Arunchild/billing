...
<div class="card mb-3 animate__animated animate__fadeIn">
    <div class="card-body p-2">
        <form action="{{ route('credit_notes.index') }}" method="GET" id="filterForm" class="row g-2 align-items-center">
            <div class="col-md-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <form action="{{ route('credit_notes.destroy', $note->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?')">
                                @csrf
                                @method('DELETE')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="creditNoteModalTitle">Create Credit Note</h5>
...
<script>
    function openCreateModal() {
        $('#creditNoteModalTitle').text('Create Credit Note');
        $('#creditNoteForm').attr('action', '{{ route('credit_notes.store') }}');
        $('#methodField').html('');
        
        $('#noteNumber').val('AUTO-GEN');
    ...
    function openEditModal(note) {
        $('#creditNoteModalTitle').text('Edit Credit Note');
        $('#creditNoteForm').attr('action', '/credit_notes/' + note.id);
